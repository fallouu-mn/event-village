...
import {
    ...
    Mail, Send, User, UserCheck, Banknote,
} from 'lucide-react';
...
export default function PartnerEventTeamPage() {
    ...
    // Confirmation d'attribution du rôle Contrôleur pour un compte existant
    ...
    return (
        <div className="max-w-2xl mx-auto px-4 py-6 space-y-6">
            ...
            <div className="flex items-center justify-between gap-3">
                ...
                <Link
                    href={`/partner/events/${eventId}/caisse`}
                    className="px-3 py-1.5 rounded-xl border border-amber-500/30 bg-amber-500/10 hover:bg-amber-500/20 text-xs font-bold text-amber-700 dark:text-amber-300 transition-colors flex items-center gap-1.5"
                >
                    <Banknote size={14} /> Z de Caisse & PIN
                </Link>
            </div>
                ...
                {existingAccountConfirm && (
                    <div className="space-y-4 py-2">
                        ...
                        <div className="p-3.5 rounded-xl bg-emerald-50 dark:bg-emerald-950/30 border border-emerald-200 dark:border-emerald-800/40 text-xs text-emerald-800 dark:text-emerald-300 space-y-1.5 leading-relaxed">
                            ...
                            <p>
                                Cet utilisateur conservera l&apos;intégralité de son historique et ses fonctionnalités Client (achats de billets, commandes, réservations, solde portefeuille) tout en accédant aux outils de contrôle pour votre événement.
                            </p>
