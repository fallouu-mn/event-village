                            ...
                            <div className="space-y-4">
                                {programItems.map((item, index) => (
                                    <div key={item.id} className="p-4 rounded-xl bg-slate-50 dark:bg-zinc-800/60 border border-slate-200 dark:border-zinc-700 space-y-3">
                                        <div className="flex items-center justify-between">
                                            <span className="text-xs font-bold text-[#FF6B35]">Activite #{index + 1}</span>
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            {[
                                ...
                                <label key={svc.key} className="p-4 rounded-xl border border-slate-200 dark:border-zinc-800 flex items-start gap-3 cursor-pointer hover:border-[#FF6B35] transition-all">
