  ...
  if (!isAuthenticated || !profile) {
    return (
      <div className="max-w-md mx-auto min-h-[60vh] flex flex-col items-center justify-center text-center p-6 space-y-6">
        <div className="w-20 h-20 rounded-3xl bg-orange-100 dark:bg-orange-950/40 text-[#FF6B35] flex items-center justify-center">
          <User size={40} />
        </div>
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6 pb-20">
      ...
      <div className="p-6 rounded-3xl bg-white dark:bg-[#1E1E1E] border border-slate-200/80 dark:border-zinc-800 shadow-xs flex flex-col sm:flex-row items-center sm:items-start gap-4 text-center sm:text-left">
        <div className="w-20 h-20 rounded-2xl bg-orange-100 dark:bg-orange-950/40 text-[#FF6B35] font-black text-2xl flex items-center justify-center border-2 border-orange-200 dark:border-orange-900/50 shadow-sm flex-shrink-0">
          {initials}
        </div>
      ...
      <div className="space-y-3">
        ...
        <Link
          href="/wallet"
          className="p-4 rounded-3xl bg-white dark:bg-[#1E1E1E] border border-slate-200/80 dark:border-zinc-800 shadow-xs hover:border-[#FF6B35]/40 transition-all flex items-center justify-between group"
        >
          <div className="flex items-center gap-3.5">
            <div className="w-10 h-10 rounded-2xl bg-orange-50 dark:bg-orange-950/40 text-[#FF6B35] flex items-center justify-center">
              <Wallet size={20} />
            </div>
            <div>
              <h4 className="text-xs sm:text-sm font-black text-slate-900 dark:text-white group-hover:text-[#FF6B35] transition-colors">
          ...
          <ChevronRight size={18} className="text-slate-400 group-hover:text-[#FF6B35] transition-colors" />
        </Link>
